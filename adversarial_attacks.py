...
if __name__ == "__main__":
    run_adversarial_experiment(
        checkpoint_paths= [
            ...
            "checkpoints_benchmark/CIFAR10_Reduced_network_momentum_True_adaptStep_False_SigSize_36_24_4.pth",
            "checkpoints_benchmark/CIFAR10_Reduced_network_momentum_True_adaptStep_True_SigSize_36_24_4.pth",
            ],
        n_images=200,
        epsilons=[0.01, 0.05, 0.1, 0.2],
        n_pixels_list=[None],
